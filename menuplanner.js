var recipe = [
    ...
    "Guacajacks and salad <br> BOSH page 47",
    ...
    "Fragrant Veg Stoup with new pototoes <br> VEG 64",
    "Summer Veg Coconut Curry <br> VEG page 68",
    "Tomato & Black Bean Salad with<br>cumin dressing <br> VEG page 156",
    "Veggie Peanut Satay Noodles <br> Recipe Keeper",
    "Swede Laksa <br> EAST page 74",
    "New Potato, Chard & Coconut Curry <br> EAST page 122",
    "Jersey Royal and Green Bean Istoo <br>with rice <br> EAST page 112",
    "'Fish' Finger Wraps <br> Own recipe",
    "'Chicken' wraps <br> Own recipe",
    "White Miso Ramen with tofu & asaparagus <br> EAST page 82",
    ...
    "'Chicken' with Vegetables<br> with buttered potatoes/mash <br> Own recipe",
    "Creamy Pasta Bake <br> Own recipe (Rich)",
    "Simple Tomato Pasta <br> Own recipe",
    "Quick Shepherds pie with lentils <br> Own recipes"
